...
const ANNOUNCEMENTS: Announcement[] = [
  {
    id: "2026-06-16-ui-redesign",
    date: "2026-06-16",
    title: "🎨 工作台全新 UI 上线，更简洁更现代",
    desc: "左侧导航、方案面板、预览区域全部重新设计，配色更清爽，操作更直觉。每一次点击都更流畅～",
  },
  {
    id: "2026-06-16-multi-reference",
    date: "2026-06-16",
    title: "🖼️ 参考图支持多张上传，生图更全面",
    desc: "不再只传一张参考图！现在支持同时上传多张商品图和参考图，AI 会从不同角度参考你的产品，生成的图片更贴合原貌。",
  },
  {
    id: "2026-06-16-direct-generate",
    date: "2026-06-16",
    title: "🚀 一键直接生成，跳过方案直接出图",
    desc: "新增「直接生成」按钮，跳过方案环节，上传商品图 + 写需求后直接生成图片，最快路径直达结果。",
  },
  {

...
export const DEFAULT_FRAGMENTS: PromptFragment[] = [
  ...
  // image_type
  {
    ...
    promptFragment:
      "specification-style e-commerce information image, show product proportions, structure and detail zones in a clean information-card composition, if user provides specific dimensions display them accurately, otherwise use blank specification areas",
    tags: ["规格", "信息", "版式"],
    sortOrder: 7,
    enabled: true,
  },
  ...
  // image_type
  {
    ...
    promptFragment:
      "application-oriented e-commerce product image in a quality inspection environment, clean measurement tools or inspection setup subtly in the background, professional precision verification atmosphere, product remains accurate and clearly visible, render real measurement labels and numbers if user provides them",
    tags: ["质检", "检测", "场景"],
    sortOrder: 13,
    enabled: true,
  },
  ...
  // negative
  {
    ...
    promptFragment: "no fake readable text, no gibberish words, no incorrect Chinese or English text, no fabricated labels, render real numbers and measurements if user provides them",
    tags: ["无虚假文字", "无乱码", "无假数字"],
    sortOrder: 16,
    enabled: true,
  },
